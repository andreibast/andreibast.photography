<div class="modal fade element-visible-from-sm element-visible-xs mt-3" id="filter-xs" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Filter Pictures By:</h5>
    ...
    ---------------------->
      ...
      <div>
                      ...
                      <div class="card card-modals">
                          <div class="card-body ">
                              ...
                              <div class="custom-control-label text-warning"> 
                                  <h6><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> 
                                  <i class="fa fa-star"></i> <i class="fa fa-star"></i> </h6>
                              </div>
                              </label>
                              ...
                              <input type="checkbox" checked="" class="custom-control-input">
                              <div class="custom-control-label text-warning"> 
                                  <h6><i class="fa fa-star"></i> <i class="fa fa-star"></i>  </h6>
                              </div>
                              </label>
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="btn btn-primary">Apply Selected Filters</button>
        </div>
